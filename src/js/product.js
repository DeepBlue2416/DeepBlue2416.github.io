...
(function () {
  ...
  function cmpIcon(a) {
    return `<svg viewBox="0 0 24 24" class="w-5 h-5 ${a ? "text-brand" : "text-ink-mute"}" fill="none" stroke="currentColor" stroke-width="1.7"><path d="M12 3v18M5 7h14M7 7l-3 6a3 3 0 006 0L7 7zm10 0l-3 6a3 3 0 006 0l-3-6z"/></svg>`;
  }
  ...
  function wire(p, variants) {
    ...
    if (frames.length > 1) {
      media.addEventListener("mousemove", (e) => {
        ...
        let i = Math.floor(((e.clientX - r.left) / r.width) * frames.length);
